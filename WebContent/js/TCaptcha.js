...
, function(t, e, n) {
    ...
    var r = Object.prototype.hasOwnProperty
      ...
      , s = function(t) {
        if (!t || "[object Object]" !== o.call(t))
            return !1;
        var e, n = r.call(t, "constructor"), a = t.constructor && t.constructor.prototype && r.call(t.constructor.prototype, "isPrototypeOf");
        if (t.constructor && !n && !a)
            return !1;
        for (e in t)
            ;
    ...
    t.exports = function f() {
        ...
        for ("boolean" == typeof i && (h = i,
        i = arguments[1] || {},
        l = 2),
        (null == i || "object" != typeof i && "function" != typeof i) && (i = {}); l < d; ++l)
            if (null != (t = arguments[l]))
                for (e in t)
                    n = p(i, e),
                    i !== (r = p(t, e)) && (h && r && (s(r) || (o = c(r))) ? (o ? (o = !1,
                    a = n && c(n) ? n : []) : a = n && s(n) ? n : {},
                    u(i, {
                        name: e,
                        newValue: f(h, a, r)
        ...
        for (var r = 0; r < t.length; r++) {
            ...
            if (a) {
                ...
                for (; i < o.parts.length; i++)
                    a.parts.push(l(o.parts[i], e))
            } else {
                var c = [];
                for (i = 0; i < o.parts.length; i++)
                    c.push(l(o.parts[i], e));
                n[o.id] = {
                    id: o.id,
                    refs: 1,
                    parts: c
        ...
        function str(t, e) {
            ...
            case "object":
                ...
                if (rep && "object" === (void 0 === rep ? "undefined" : _typeof(rep)))
                    for (a = rep.length,
                    n = 0; n < a; n += 1)
                        "string" == typeof rep[n] && (o = str(r = rep[n], s)) && i.push(quote(r) + (gap ? ": " : ":") + o);
                else
                    for (r in s)
...
, function(t, e, n) {
    t.exports = function(t) {
        var e, n = [], r = document, o = r.documentElement, a = o.doScroll, i = (a ? /^loaded|^c/ : /^loaded|c/).test(r.readyState);
        function c(t) {
            for (i = 1; t = n.shift(); )
                t()
        }
        ...
        , !1),
        a && r.attachEvent("onreadystatechange", e = function() {
...
, function(t, e, n) {
    ...
    t.exports = function o(t, e, n, a, i, c, s) {
        ...
        function f(t) {
            u || (t && "load" === t.type || /^(loaded|complete)$/.test(this.readyState)) && (a() ? (u = !0,
            i && i()) : l())
        }
